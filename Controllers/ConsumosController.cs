...
namespace mf_dev_backend.Controllers
{
    public class ConsumosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Data,Valor,Km,Tipo,IdVeiculo")] Consumo consumo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,Data,Valor,Km,Tipo,IdVeiculo")] Consumo consumo)
        {
            if (id != consumo.Id)
            {
                return NotFound();
